...
Device::CreateRenderTargetView(ID3D11Resource* pResource,
	...
	if (pResource == nullptr) {
		WARNING("ERROR: Device::CreateRenderTargetView : [CREATION OF RESOURCE : FALSE] [CHECHK FOR ID3D11Resource* pResource] \n");
		exit(1);
	}
	else if (ppRTView == nullptr) {
		WARNING("ERROR: Device::CreateRenderTargetView : [CREATION OF RESOURCE : FALSE] [CHECHK FOR ID3D11RenderTargetView** ppRTView] \n");
		exit(1);
	}
	else {
...
Device::CreateTexture2D(const D3D11_TEXTURE2D_DESC* pDesc,
	...
	if (pDesc == nullptr) {
		WARNING("ERROR: Device::CreateTexture2D : [CREATION OF RESOURCE : FALSE] [CHECHK FOR D3D11_TEXTURE2D_DESC* pDesc] \n");
		exit(1);
	}
	else if (ppTexture2D == nullptr) {
		WARNING("ERROR: Device::CreateTexture2D : [CREATION OF RESOURCE : FALSE] [CHECHK FOR ID3D11Texture2D** ppTexture2D] \n");
		exit(1);
	}
	else {
...
Device::CreateVertexShader(const void* pShaderBytecode,
	...
	if (pShaderBytecode == nullptr) {
		WARNING("ERROR: Device::CreateVertexShader : [CREATION OF RESOURCE : FALSE] [CHECHK FOR const void* pShaderBytecode] \n");
		exit(1);
	}
	else if (ppVertexShader == nullptr) {
		WARNING("ERROR: Device::CreateVertexShader : [CREATION OF RESOURCE : FALSE] [CHECHK FOR ID3D11VertexShader** ppVertexShader] \n");
		exit(1);
	}
	else {
...
Device::CreateInputLayout(const D3D11_INPUT_ELEMENT_DESC* pInputElementDescs,
	...
	if (pInputElementDescs == nullptr) {
		WARNING("ERROR: Device::CreateInputLayout : [CREATION OF RESOURCE : FALSE] [CHECHK FOR const D3D11_INPUT_ELEMENT_DESC* pInputElementDescs] \n");
		exit(1);
	}
	else if (pShaderBytecodeWithInputSignature == nullptr) {
		WARNING("ERROR: Device::CreateInputLayout : [CREATION OF RESOURCE : FALSE] [CHECHK FOR const void* pShaderBytecodeWithInputSignature] \n");
		exit(1);
	}
	else if (ppInputLayout == nullptr) {
		WARNING("ERROR: Device::CreateInputLayout : [CREATION OF RESOURCE : FALSE] [CHECHK FOR ID3D11InputLayout** ppInputLayout] \n");
		exit(1);
	}
	else {
...
Device::CreatePixelShader(const void* pShaderBytecode,
	...
	if (pShaderBytecode == nullptr) {
		WARNING("ERROR: Device::CreatePixelShader : [CREATION OF RESOURCE : FALSE] [CHECHK FOR const void* pShaderBytecode] \n");
		exit(1);
	}
	else if (ppPixelShader == nullptr) {
		WARNING("ERROR: Device::CreatePixelShader : [CREATION OF RESOURCE : FALSE] [CHECHK FOR ID3D11PixelShader** ppPixelShader] \n");
		exit(1);
	}
	else {
...
Device::CreateBuffer(const D3D11_BUFFER_DESC* pDesc,
	...
	if (pDesc == nullptr) {
		WARNING("ERROR: Device::CreateBuffer : [CREATION OF RESOURCE : FALSE] [CHECHK FOR const D3D11_BUFFER_DESC* pDesc] \n");
		exit(1);
	}
	else if (ppBuffer == nullptr) {
		WARNING("ERROR: Device::CreateBuffer : [CREATION OF RESOURCE : FALSE] [CHECHK FOR ID3D11Buffer** ppBuffer] \n");
		exit(1);
	}
	else {
...
Device::CreateSamplerState(const D3D11_SAMPLER_DESC* pSamplerDesc,
	...
	if (pSamplerDesc == nullptr) {
		WARNING("ERROR: Device::CreateSamplerState : [CREATION OF RESOURCE : FALSE] [CHECHK FOR const D3D11_SAMPLER_DESC* pSamplerDesc] \n");
		exit(1);
	}
	else if (ppSamplerState == nullptr) {
		WARNING("ERROR: Device::CreateSamplerState : [CREATION OF RESOURCE : FALSE] [CHECHK FOR ID3D11SamplerState** ppSamplerState] \n");
		exit(1);
	}
	else {
